...
- **CMD** (Central Moment Discrepancy, ICLR-17 and Information Sciences) [61], [62]
    - [Keras(Theano)](https://github.com/wzell/cmd) | [Keras(journal extension)](https://github.com/wzell/mann)
...
[62] W. Zellinger, B.A. Moser, T. Grubinger, E. Lughofer, T. Natschlaeger, and S. Saminger-Platz, "Robust unsupervised domain adaptation for neural networks via moment alignment," Information Sciences, in press, https://doi.org/10.1016/j.ins.2019.01.025, arXiv preprint arxiv:1711.06114, 2019
